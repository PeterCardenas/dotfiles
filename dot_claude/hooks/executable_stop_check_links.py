...
def _main() -> None:
    ...
    _output(
        ...
        "plausible guess is fine. Prefer links you already used in your turn and file "
        "paths over GitHub links (in the form file/path.txt not file:///abs/path/file.xt). "
