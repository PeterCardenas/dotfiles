...
vim.api.nvim_set_hl(0, '@markup.shortcut_link.markdown_inline', { fg = '#C0CAF5', underdotted = false, nocombine = true, force = true })

local filetype_options_group = vim.api.nvim_create_augroup('FiletypeOptions', { clear = true })

vim.api.nvim_create_autocmd('FileType', {
  pattern = { 'conf', 'sh', 'javascript', 'yaml*', 'markdown', 'html', 'codeowners' },
...
vim.api.nvim_create_autocmd('TextYankPost', {
  callback = function()
    -- TODO: figure out if conflicts with yanky?
