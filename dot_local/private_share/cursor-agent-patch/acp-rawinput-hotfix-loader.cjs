...
const ACP_HANDLE_PROMPT_AFTER =
  'handlePrompt(e){return $(this,void 0,void 0,(function*(){var t;null===(t=this.pendingPromptCancel)||void 0===t||t.call(this);const[o,n]=this.ctx.withCancel();this.pendingPromptCancel=n;let s=e,r=0;try{for(;!o.canceled;){this._lastAssistantMessage="";yield this.processPrompt(s,o);if(o.canceled)break;let e;try{if(this.hookExecutor){const t=yield this.hookExecutor.executeHookForStep("stop",{conversation_id:this.sessionId,status:"success",model:this.currentModel&&this.currentModel.modelId?this.currentModel.modelId:"unknown",loop_count:r,last_assistant_message:this._lastAssistantMessage||void 0});e="string"==typeof(null==t?void 0:t.followup_message)&&t.followup_message.trim().length>0?t.followup_message:"deny"===(null==t?void 0:t.permission)&&"string"==typeof(null==t?void 0:t.user_message)&&t.user_message.trim().length>0?t.user_message:void 0}}catch(e){(0,b.debugLog)("Stop hook execution failed in ACP handlePrompt:",e)}if(!e)break;r+=1,(0,b.debugLog)(`[hooks] Stop hook returned followup message, continuing ACP prompt loop (${r})`),s={prompt:[{type:"text",text:e}]}}}catch(e){if(o.canceled)return{stopReason:"cancelled"};throw e}finally{this.pendingPromptCancel=null}return o.canceled?{stopReason:"cancelled"}:{stopReason:"end_turn"}}))}';
